...
public final class FragmentMainBinding implements ViewBinding {
  ...
  private FragmentMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView idRecycler) {
    this.rootView = rootView;
    this.idRecycler = idRecycler;
  }
  ...
  public static FragmentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.id_recycler;
      RecyclerView idRecycler = ViewBindings.findChildViewById(rootView, id);
      if (idRecycler == null) {
        break missingId;
      }

      return new FragmentMainBinding((ConstraintLayout) rootView, idRecycler);
    }
